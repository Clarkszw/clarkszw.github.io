...
# Documentation
[^1]: We can use the [Split-and-Combine workflow](https://jofrhwld.github.io/teaching/courses/2017_lsa/lectures/Session_3.nb.html).
[^2]: We can use the [`drop_na()` function](https://tidyr.tidyverse.org/reference/drop_na.html).
[^3]: We can use the [`stringr::str_split()` function](https://www.rdocumentation.org/packages/stringr/versions/1.4.1/topics/str_split).
